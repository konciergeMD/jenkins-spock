...
//						.setScanners(Scanners.SubTypes.filterResultsBy(c -> false))
...
//            for( Class<?> annotated_class : new Reflections( _package.orElse("") ).get(TypesAnnotated.with(_annotation).asClass()) ) {
